...
List<Func<IReadOnlyList<PointF>, Size, float, int>> funcs = new() { BasicSearch, ParallelSearch, GridSearch, ParallelGridSearch };
...
int ParallelGridSearch(IReadOnlyList<PointF> points, Size size, float radius)
{
    //Create Offsets
    List<Point> offsets = new() {
        new Point(-1, -1), new Point( 0, -1), new Point( 1, -1),
